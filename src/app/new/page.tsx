...
async function createToDo(data: FormData) {
  ...
  await prisma.todo.create({ data: {title: title, complete: false, id: randomUUID()}})
  ...
  return (
    <>
      ...
      <form action={createToDo} className="flex gap-2 flex-col">
        <input type="text" name="title" className="border border-slate-300 bg-transparent rounded px-2 py-1 outline-none focus-with:border-slate-100"></input>
